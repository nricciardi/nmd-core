...
pub(super) const IDENTIFIER_PATTERN: &str = r"#([\w-]+)";
pub(super) const NEW_LINE_PATTERN: &str = r"(?:\n|\r\n)";
...
pub(super) const MAX_HEADING_LEVEL: u32 = 6;


pub(super) const STYLE_PATTERN: &str = r"([^{}]*(?:\.(?:\w+|\d+)\s*|(?:\w+\s*:\s*[^;{}]+\s*;?))*)";
