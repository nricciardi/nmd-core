...
pub trait Assembler: Debug + Sync + Send {
    ...
    fn assemble_document_standalone(&self, document: &CompilationOutcome, _page_title: &String, _toc: Option<&TableOfContents>, _bibliography: Option<&Bibliography>, configuration: &AssemblerConfiguration) -> Result<String, AssemblerError>;

    fn assemble_bundle(&self, compiled_preamble: &Vec<CompilationOutcome>, compiled_chapters: &Vec<CompilationOutcome>, configuration: &AssemblerConfiguration) -> Result<String, AssemblerError>;
