...
#[derive(Debug)]
pub enum ImageBlockLoadingRule {
    SingleImage,
    AbridgedImage,
    MultiImage,
}
...
mod test {
    ...
    use super::ImageBlockLoadingRule;
    ...
    fn load_single_image_from_url() {
        ...
        let image = ImageBlockLoadingRule::load_single_image(&nmd_text, &codex, &LoadConfiguration::default(), LoadConfigurationOverLay::default()).unwrap();
    ...
    fn load_abridged_image() {
        ...
        let image = ImageBlockLoadingRule::load_abridged_image(&nmd_text, &codex, &LoadConfiguration::default(), LoadConfigurationOverLay::default()).unwrap();
    ...
    fn load_multi_image() {
        ...
        let multi_image = ImageBlockLoadingRule::load_multi_image(&nmd_text, &codex, &LoadConfiguration::default(), loader_configuration_overlay).unwrap();
