...
impl CachedDiskResource {
    fn new(location: PathBuf) -> Result<Self, MultiMediaObjectError> {
    ...
    pub fn dump_cached_content(&mut self) -> Result<(), MultiMediaObjectError> {
    ...
    pub fn refresh_cached_content(&mut self) -> Result<(), MultiMediaObjectError> {
